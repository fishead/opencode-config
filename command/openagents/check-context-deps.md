...
<workflow id="analyze_context_dependencies">
  <stage id="1" name="ScanAgents" required="true">
    ...
    **Search patterns**:
    - `/Users/fishead/.config/opencode/context/` (direct path references)
    - `@/Users/fishead/.config/opencode/context/` (@ symbol references)
  ...
  <stage id="3" name="ValidateContextFiles" required="true">
    ...
    **Check existence**:
    ```bash
    test -f /Users/fishead/.config/opencode/context/core/standards/code-quality.md
    ```
  ...
  <stage id="4" name="Report" required="true">
    ...
    **Uses but not declared**:
    - context:core/standards/code (referenced 3 times)
      - Line 64: "Code tasks → /Users/fishead/.config/opencode/context/core/standards/code-quality.md (MANDATORY)"
      - Line 170: "Read /Users/fishead/.config/opencode/context/core/standards/code-quality.md NOW"
...
```bash
grep -rn "\/Users/fishead/.config/opencode/context/" .opencode/agent/ .opencode/command/
```
...
- `/Users/fishead/.config/opencode/context/core/standards/code-quality.md` → `context:core/standards/code`
- `@/Users/fishead/.config/opencode/context/openagents-repo/quick-start.md` → `context:openagents-repo/quick-start`
...
task(
  ...
  prompt=`
    ...
    2. Search for these patterns:
       - "/Users/fishead/.config/opencode/context/core/" (direct paths)
       - "@/Users/fishead/.config/opencode/context/" (@ references)
    ...
    4. For each context file in /Users/fishead/.config/opencode/context/core/:
...
✓ /Users/fishead/.config/opencode/context/core/context-system.md (1 reference)
  - Line 15: "Load: context:core/context-system"
✓ /Users/fishead/.config/opencode/context/core/context-system/standards/mvi.md (2 references)
...
- **Context guide**: `/Users/fishead/.config/opencode/context/openagents-repo/quality/registry-dependencies.md`
