...
┌──────────────────────────────────────────────────┐
│ STEP 1: ContextScout                             │
│ → Search internal context (/Users/fishead/.config/opencode/context/)  │
...
- Cache useful docs in `/Users/fishead/.config/opencode/context/development/frameworks/` if frequently used
...
**Rule**: If it's not in `/Users/fishead/.config/opencode/context/`, use ExternalScout.
...
| **Location** | `/Users/fishead/.config/opencode/context/` | Internet (Context7, official docs) |
...
- **Code Standards**: `/Users/fishead/.config/opencode/context/core/standards/code-quality.md`
