...
**Index Location**: `/Users/fishead/.config/opencode/context/index.md` - Quick map of all contexts
...
**Central Index**: `/Users/fishead/.config/opencode/context/index.md` - Ultra-compact map of all contexts
...
All files are in `/Users/fishead/.config/opencode/context/core/` with organized subfolders:
...
- Load `/Users/fishead/.config/opencode/context/index.md`
...
### /Users/fishead/.config/opencode/context/core/standards/security-patterns.md
- Error handling
- Security patterns
- Common code patterns

### /Users/fishead/.config/opencode/context/core/standards/code-analysis.md
- Analyzing codebase patterns
- Investigating bugs
- Evaluating architecture

### /Users/fishead/.config/opencode/context/core/workflows/task-delegation.md
- Delegating to general agent
- Creating task context
- Multi-file coordination

### /Users/fishead/.config/opencode/context/core/workflows/feature-breakdown.md
- Tasks with 4+ files
- Estimated effort >60 minutes
- Complex dependencies

### /Users/fishead/.config/opencode/context/core/workflows/session-management.md
- Session lifecycle
- Cleanup procedures
- Session isolation
