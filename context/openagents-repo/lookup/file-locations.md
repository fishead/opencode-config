...
| **Context files** | `/Users/fishead/.config/opencode/context/` |
...
| **New context** | `/Users/fishead/.config/opencode/context/{category}/{name}.md` |
...
```
/Users/fishead/.config/opencode/context/{category}/{topic}.md
```

**Examples**:
- `/Users/fishead/.config/opencode/context/core/standards/code-quality.md`
- `/Users/fishead/.config/opencode/context/development/frontend/react/react-patterns.md`
- `/Users/fishead/.config/opencode/context/content-creation/principles/copywriting-frameworks.md`
...
```bash
# By category
ls /Users/fishead/.config/opencode/context/{category}/

# All context
find /Users/fishead/.config/opencode/context -name "*.md"
```
