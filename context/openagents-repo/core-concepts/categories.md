...
/Users/fishead/.config/opencode/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
mkdir -p /Users/fishead/.config/opencode/context/{category}
...
```bash
cat > /Users/fishead/.config/opencode/context/{category}/navigation.md << 'EOF'
...
```
/Users/fishead/.config/opencode/context/{category}/
...
Loads: `/Users/fishead/.config/opencode/context/development/react-patterns.md`
