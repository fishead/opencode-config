...
- Locate context directories (`/Users/fishead/.config/opencode/context/`, `docs/`, `.context/`, etc.)
...
```
/Users/fishead/.config/opencode/context/
...
```bash
list(path="/Users/fishead/.config/opencode/context")
```
...
list(path="/Users/fishead/.config/opencode/context/{category}")

# Read relevant files
read(filePath="/Users/fishead/.config/opencode/context/{category}/{file}.md")
```
...
**Context Location**: `/Users/fishead/.config/opencode/context/`
**Files Searched**: 12
...
**Primary Location**: `/Users/fishead/.config/opencode/context/`
...
#### ⭐⭐⭐⭐⭐ Code Standards
**Path**: `/Users/fishead/.config/opencode/context/core/standards/code.md`
...
### Files to Load (Priority Order)
1. `/Users/fishead/.config/opencode/context/core/standards/code.md` - CRITICAL for all code implementation
2. `/Users/fishead/.config/opencode/context/core/standards/style-guide.md` - Formatting and style rules
3. `/Users/fishead/.config/opencode/context/development/best-practices.md` - Additional development guidelines
...
### Additional Context Available
If you need more information on:
- **Testing standards** → Check `/Users/fishead/.config/opencode/context/core/standards/tests.md`
- **Design patterns** → Check `/Users/fishead/.config/opencode/context/core/standards/patterns.md`
```
...
**Context Location**: `docs/` and `/Users/fishead/.config/opencode/context/`
**Files Searched**: 8
...
/Users/fishead/.config/opencode/context/core/workflows/
└── review.md ⭐ FOUND
```
...
- Follow code standards in `/Users/fishead/.config/opencode/context/core/standards/code.md`
...
3. `/Users/fishead/.config/opencode/context/core/workflows/review.md` - Code review expectations
...
### Additional Context Available
If you need more information on:
- **Code standards** → Check `/Users/fishead/.config/opencode/context/core/standards/code.md`
- **Testing guidelines** → Check `/Users/fishead/.config/opencode/context/core/standards/tests.md`
```

## Discovery Patterns

### Pattern 1: Well-Organized Context
Repository has clear context structure (`/Users/fishead/.config/opencode/context/` or `docs/`)
...
- `/Users/fishead/.config/opencode/context/` - Not found
- `docs/` - Not found
- `.context/` - Not found
- `context/` - Not found
