...
id: contextscout
name: ContextScout
description: "Discovers and recommends context files from /Users/fishead/.config/opencode/context/ ranked by priority. Suggests ExternalScout when a framework/library is mentioned but not found internally."
...
2. **Follow navigation** — Read `navigation.md` files from `/Users/fishead/.config/opencode/context/` downward. They are the map.
...
```
1. Read `/Users/fishead/.config/opencode/context/navigation.md`                    ← root map
2. Read `/Users/fishead/.config/opencode/context/{domain}/navigation.md`           ← domain map
3. Drill deeper if needed: `/Users/fishead/.config/opencode/context/{domain}/{sub}/navigation.md`
```
...
**File**: `/Users/fishead/.config/opencode/context/path/to/file.md`
**Contains**: What this file covers

## High Priority

**File**: `/Users/fishead/.config/opencode/context/another/file.md`
**Contains**: What this file covers

## Medium Priority

**File**: `/Users/fishead/.config/opencode/context/optional/file.md`
**Contains**: What this file covers
```
...
1. Search `/Users/fishead/.config/opencode/context/` for any coverage (grep for the library name)
