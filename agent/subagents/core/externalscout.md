...
3. Suggest checking `/Users/fishead/.config/opencode/context/` for cached docs
...
- **External Libraries Workflow**: `/Users/fishead/.config/opencode/context/core/workflows/external-libraries.md` — Full decision flow for when to use ExternalScout
