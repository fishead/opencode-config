...
**The AOC solution:** Store team patterns in `/Users/fishead/.config/opencode/context/project/`. Commit to repo. Everyone uses same standards.
...
# Commit to repo
git add /Users/fishead/.config/opencode/context/
...
Store patterns in `/Users/fishead/.config/opencode/context/project/`. Commit to repo. Entire team uses same standards. New developers inherit patterns automatically.
...
A: Commit `/Users/fishead/.config/opencode/context/project/` to your repo. Team members automatically use same patterns.
