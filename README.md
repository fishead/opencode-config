...
cp -r /Users/fishead/.config/opencode/context ~/.opencode/
```
...
A: Edit `~//Users/fishead/.config/opencode/context/project/project-context.md` - agents automatically load this file.
...
**Context-aware:** Agents automatically load patterns from `/Users/fishead/.config/opencode/context/` to follow your coding standards.
...
1. **Add your patterns** to `~//Users/fishead/.config/opencode/context/project/project-context.md`
...
nano ~//Users/fishead/.config/opencode/context/project/project-context.md
